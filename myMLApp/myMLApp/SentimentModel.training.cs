    ...
    public partial class SentimentModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(@"col0", @"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(l1Regularization:3.61555250660027F,l2Regularization:0.227532352914835F,labelColumnName:@"col1",featureColumnName:@"Features"))      
